...
<script>
    ...
    $(document).ready(function(){
        $("#more").click(function(){
            ...
            $("#more").text('查看更多');
            $.ajax({
                url:'${pageContext.request.contextPath}/home/search/SearchList',
                type:'post',
                data:{rows:10,page:page++,Word:${Word}},
                dataType:'json',
                success:function(data){
                    if(data.type == 'success'){
                        ...
                        for(var i=0;i<articleList.length;i++){
                            ...
                            article +='<a class="focus" href="#" title="'+articleList[i].title+'" target="_blank" >';
                            ...
                            article +='<header><a class="cat" href="${pageContext.request.contextPath}/home/search/get_searchList?Id='+articleList[i].categoryId+'" title="'+articleList[i].categoryId.name+'" >'+articleList[i].category.name+'<i></i></a>';
                            ...
                            article +='<a class="comment" href="#" title="评论" target="_blank" ><i class="glyphicon glyphicon-comment"></i>'+articleList[i].commentNumber+'</a></p>';
